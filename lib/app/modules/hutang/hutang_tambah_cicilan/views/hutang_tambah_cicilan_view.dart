...
class HutangTambahCicilanView extends GetView<HutangTambahCicilanController> {
  const HutangTambahCicilanView({Key? key}) : super(key: key);
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildTextField(
          label: 'Nama Cicilan',
          hint: 'Masukkan nama cicilan',
          controller: controller.nameController,
        ),
          SizedBox(height: AppResponsive.h(3)),
          _buildTextField(
            label: 'Keterangan',
            hint: 'Masukkan keterangan cicilan',
          ...
          Obx(() => Text(
            'Sisa hutang: ${controller.formatCurrency(controller.sisaHutang.value)}',
  ...
  Widget _buildHeader() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Obx(() => Text(
            "Nama Penghutang: ${controller.namaPenghutang.value}",
            style: AppText.h6(color: AppColors.dark),
          )),
          SizedBox(height: AppResponsive.h(1)),
          Obx(() => Text(
            "Total Hutang: ${controller.formatCurrency(controller.totalHutang.value)}",
