      ...
      child: Column(
        ...
        children: [
          ...
          _buildTextField(
            ...
            hint: 'Masukkan nama penghutang',
            controller: controller.nameController,
          ),
          SizedBox(height: AppResponsive.h(3)),
          _buildTextField(
            label: 'Keterangan',
            hint: 'Masukkan keterangan hutang',
  ...
  Widget _buildBottomBar() {
    return Container(
      ...
      child: Obx(() => ElevatedButton(
            onPressed: controller.isSaving.value ? null : controller.saveHutang,
