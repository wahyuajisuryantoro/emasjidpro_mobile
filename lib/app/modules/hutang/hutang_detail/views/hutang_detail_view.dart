...
class HutangDetailView extends GetView<HutangDetailController> {
  ...
  Widget _buildContent() {
    return RefreshIndicator(
      onRefresh: () => controller.fetchDetailHutang(),
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                'Status Hutang: ${controller.status.value}',
                style: AppText.h6(
                  color: controller.status.value.toLowerCase() == 'lunas'
                      ? AppColors.success
                      : AppColors.warning,
          ...
          Text(
            controller.status.value.toLowerCase() == 'lunas'
                ? 'Hutang ini telah lunas dibayar.'
                : 'Hutang ini belum lunas. Segera lakukan pembayaran.',
          ...
          Row(
            ...
            children: [
              ...
              Text(
                controller.formatCurrency(controller.totalHutang.value),
                style: AppText.bodyMedium(
          ...
          Row(
            ...
            children: [
              ...
              Text(
                controller.formatCurrency(controller.sisaHutang.value),
                style: AppText.bodyMedium(
                  color: AppColors.dark,
                ),
              ),
