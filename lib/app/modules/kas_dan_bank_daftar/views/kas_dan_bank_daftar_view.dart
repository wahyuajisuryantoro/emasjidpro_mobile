...
class KasDanBankDaftarView extends GetView<KasDanBankDaftarController> {
  const KasDanBankDaftarView({super.key});
        ...
        children: [
          Expanded(
            ...
            child: GestureDetector(
              ...
              child: Container(
                padding: AppResponsive.padding(vertical: 1.2, horizontal: 2),
                decoration: BoxDecoration(
  ...
  Widget _buildTransactionItem(Map<String, dynamic> transaction) {
    ...
    switch (type) {
      case 'setor':
        icon = Remix.arrow_down_circle_fill;
        iconColor = AppColors.primary;
        break;
      case 'tarik':
        icon = Remix.arrow_up_circle_fill;
          ...
          Column(
            ...
            children: [
              Text(
                ...
                style: AppText.pSmallBold(color: iconColor),
              ),
              Text(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Tidak ada transaksi kas dan bank yang ditemukan',
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSortOption('Kode Transaksi (A-Z)', 'code_asc'),
            _buildSortOption('Kode Transaksi (Z-A)', 'code_desc'),
            SizedBox(height: AppResponsive.h(2)),
          ],
        ),
      ),
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: AppResponsive.h(3)),
            _buildTypeOption('Semua'),
            _buildTypeOption('Setor'),
            _buildTypeOption('Tarik'),
            _buildTypeOption('Transfer'),
            SizedBox(height: AppResponsive.h(2)),
          ],
        ),
      ),
