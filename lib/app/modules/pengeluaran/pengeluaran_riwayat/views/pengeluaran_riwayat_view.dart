...
class PengeluaranRiwayatView extends GetView<PengeluaranRiwayatController> {
  const PengeluaranRiwayatView({super.key});
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () => controller.fetchRiwayatPengeluaran(),
          ),
        ],
      ),
      body: Column(
