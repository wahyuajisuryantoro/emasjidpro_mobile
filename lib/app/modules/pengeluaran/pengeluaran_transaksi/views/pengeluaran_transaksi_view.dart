...
class PengeluaranTransaksiView extends GetView<PengeluaranTransaksiController> {
  const PengeluaranTransaksiView({super.key});
  ...
  Widget _buildFormHeader() {
    return Column(
      ...
      children: [
        ...
        Text(
          'Isi semua informasi yang diperlukan untuk mencatat pengeluaran baru',
  ...
  Widget _buildDestinationAccountField() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildFormLabel('Kategori Pengeluaran'),
        SizedBox(height: AppResponsive.h(1)),
        Obx(() {
