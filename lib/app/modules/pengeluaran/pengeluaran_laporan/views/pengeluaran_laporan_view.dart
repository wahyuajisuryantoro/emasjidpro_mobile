...
class PengeluaranLaporanView extends GetView<PengeluaranLaporanController> {
  const PengeluaranLaporanView({super.key});
    ...
    return Container(
      ...
      child: RadioListTile<ReportPeriod>(
        title: Text(
          title,
          style: AppText.h6(
            color: isSelected ? AppColors.danger : AppColors.dark,
          ),
        ),
        value: value,
