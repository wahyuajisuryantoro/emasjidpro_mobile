...
class KasDanBankLaporanController extends GetxController {
  ...
  Future<void> loadLaporanData() async {
    try {
      ...
      final response = await http
          .post(
            Uri.parse('${BaseUrl.baseUrl}/laporan-kasdanbank'),
            headers: {
              'Content-Type': 'application/json',
              'Authorization': 'Bearer $token',
            },
            body: json.encode({'month': selectedMonth.value}),
          )
          .timeout(Duration(seconds: 30));
  ...
  List<pw.Widget> _buildFlatWidgetList(
    ...
    return [
      ...
      _buildRincianSaldoTable(ttfBold, ttf),
      pw.SizedBox(height: 25),
      pw.Text(
      ...
      pw.TableHelper.fromTextArray(
        ...
        headers: ['Tanggal', 'Dari Rekening', 'Ke Rekening', 'Nilai'],
        data: riwayatData
            .map<List<dynamic>>((item) => [
                  _formatDateTable(item['tanggal']),
                  item['dari_rekening']?.toString() ?? '',
                  item['ke_rekening']?.toString() ?? '',
          ...
          children: [
            pw.TableRow(children: [
              ...
              pw.Container(
                ...
                child: pw.Text(
                  _formatCurrency(laporanData['total_saldo']),
                  style: pw.TextStyle(
                    font: ttfBold,
                    fontSize: 9,
                    fontWeight: pw.FontWeight.bold,
  ...
  pw.Widget _buildRincianSaldoTable(pw.Font ttfBold, pw.Font ttf) {
    final rincianSaldo = laporanData['rincian_saldo'] as List<dynamic>? ?? [];
      ...
      children: [
        ...
        pw.Table(
          ...
          children: [
            ...
            // Data rows
            ...rincianSaldo.map<pw.TableRow>((item) {
              return pw.TableRow(
                children: [
                  pw.Container(
                    alignment: pw.Alignment.centerLeft,
  ...
  String _generateFileName() {
    ...
    final monthName =
        months.firstWhere((m) => m['value'] == selectedMonth.value)['label'];
    return 'Laporan_KasBank_${monthName}_$dateStr.pdf';
  }
  ...
  Future<void> _sharePDF(String filePath) async {
    try {
      ...
      String shareText = 'Laporan Kas & Bank - ${_getReportSubtitle()}';
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Laporan kas & bank telah berhasil diekspor ke PDF',
                    style:
