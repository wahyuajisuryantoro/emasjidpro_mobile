...
class KasDanBankTarikView extends GetView<KasDanBankTarikController> {
  const KasDanBankTarikView({super.key});
  ...
  Widget _buildFormHeader() {
    return Column(
      ...
      children: [
        ...
        Text(
          'Catat transaksi penarikan dana dari akun bank untuk keperluan operasional',
        ...
        Obx(() {
          if (controller.bankAccounts.isEmpty) {
            return Container(
              ...
              child: Text(
                'Tidak ada bank dengan saldo tersedia',
  ...
  Widget _buildAmountField() {
    return Column(
      ...
      children: [
        Row(
          children: [
            _buildFormLabel('Nominal Tarik'),
            Spacer(),
            Obx(() {
              if (controller.selectedBankAccount.value != null) {
                return Text(
                  'Maks: Rp ${_formatCurrency(controller.selectedBankAccount.value!['balance'])}',
                  style: AppText.small(color: AppColors.primary),
                );
              }
      ...
      children: [
        ...
        Container(
          ...
          child: TextField(
            ...
            maxLines: 3,
            decoration: InputDecoration(
              hintText: 'Masukkan keterangan penarikan dana...',
              hintStyle: AppText.p(color: AppColors.dark.withOpacity(0.4)),
              border: InputBorder.none,
              contentPadding: AppResponsive.padding(all: 3),
            ),
  ...
  Widget _buildAttachmentField() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildFormLabel('Bukti Tarik (Opsional)'),
        SizedBox(height: AppResponsive.h(1)),
  ...
  Widget _buildSaveButton() {
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: controller.isLoading.value ? null : controller.saveTarik,
