...
class KasDanBankSetorController extends GetxController {
  ...
  Future<void> saveSetor() async {
    try {
      ...
      final uri = Uri.parse('${BaseUrl.baseUrl}/setor-kasdanbank');
      ...
      if (response.statusCode == 201) {
        ...
        if (responseData['success'] == true) {
          ...
          throw Exception(responseData['message'] ?? 'Gagal menyimpan setor');
        }
      } else {
        var errorMessage =
            'Gagal menyimpan setor. Status code: ${response.statusCode}';
        try {
