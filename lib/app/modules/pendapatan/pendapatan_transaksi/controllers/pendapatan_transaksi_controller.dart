...
class PendapatanTransaksiController extends GetxController {
  ...
  Future<void> fetchAccounts() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('${BaseUrl.baseUrl}/accounts-pendapatan'),
        headers: {
  ...
  Future<void> saveTransaction() async {
    try {
      ...
      final uri = Uri.parse('${BaseUrl.baseUrl}/transaksi-pendapatan');
      ...
      if (response.statusCode == 201) {
        ...
        if (responseData['success'] == true) {
          ...
          Future.delayed(const Duration(milliseconds: 500), () {
            Get.offAndToNamed(Routes.PENDAPATAN_RIWAYAT, result: 'refresh');
          });
        } else {
          throw Exception(
